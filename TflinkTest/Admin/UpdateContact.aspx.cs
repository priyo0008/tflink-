    ...
    public partial class UpdateContact : System.Web.UI.Page
    {
        ...
        protected void btn_save_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                SqlCommand cmd = null;
                cmd = new SqlCommand("SPUpdateContact", con);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.AddWithValue("id", hdn_id.Value);
                cmd.Parameters.AddWithValue("Desccription", txt_ContactContent.Text);
        ...
        public void getdata()
        {
            ...
            {
                reader.Read();
                txt_ContactContent.Text = Convert.ToString(reader["Desccription"]);
