<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="UpdateAbout.aspx.cs" Inherits="TflinkTest.Admin.UpdateAbout" %>
                    ...
                    <div class="form-horizontal">
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <label for="inputEmail3" class="col-sm-2 col-form-label">Home About Us Content</label>
                                <div class="col-sm-10">
                                    <%--<input type="email" class="form-control" id="inputEmail3" placeholder="Email" />--%>
                                    <asp:TextBox ID="txt_Aboutcontent" runat="server" TextMode="MultiLine" class="form-control" Rows="10"></asp:TextBox>
                                    <asp:HtmlEditorExtender ID="HtmlEditorExtender1" TargetControlID="txt_Aboutcontent" EnableSanitization="false" runat="server"></asp:HtmlEditorExtender>
                                </div>
                            </div>
                            <div class="form-group row">
