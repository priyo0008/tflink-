<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Edit_Parents.aspx.cs" Inherits="TflinkTest.FamilyTree.Edit_Parents" %>
                        ...
                        <div class="modal-body">
                            ...
                            <asp:DropDownList ID="ddl_Type" CssClass="form-control" runat="server">
                              ...
                              <asp:DropDownList ID="ddl_Changedec" CssClass="form-control" runat="server">
                                ...
                                <div class="col-md-4 form-group">
                                    Changed Date : 
                            <asp:TextBox ID="txt_date" autocomplete="off" CssClass="form-control"  runat="server"></asp:TextBox>
                                ...
                                <div class="col-md-12">
                                    <div class="modal-body">
                                        <div runat="server" id="Div3" visible="false">
                                            ...
                                            <p><span runat="server" id="fullname2"></span>  is tagged in the picture(s) below.<%-- Click on any picture for a larger image and all its details.</p>--%>
