<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.Master" AutoEventWireup="true" CodeBehind="MyTree.aspx.cs" Inherits="TflinkTest.FamilyTree.MyTree" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Panel ID="pnlPopUp" runat="server" CssClass="modalPopup" Style="display: none">
        ...
        <div class="body">
            <iframe id="iFramePersonal" src="NewSpouse.aspx" height="400px" width="100%"></iframe>
            <br />
            <br />
            <a href="MyTree1.aspx">
    ...
    <asp:Panel ID="pnlPopUpchld" runat="server" CssClass="modalPopup" Style="display: none">
        ...
        <div class="body">
            <iframe id="iFramePersonalchld" src="NewChildren.aspx" height="400px" width="100%"></iframe>
            <br />
            <br />
            <a href="MyTree1.aspx">
    ...
    <asp:Panel ID="pnlPopUpparents" runat="server" CssClass="modalPopup" Style="display: none">
        ...
        <div class="body">
            <iframe id="iFramePersonalParent" src="AddParents.aspx" height="400px" width="100%"></iframe>
            <br />
            <br />
            <a href="MyTree1.aspx">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            Date of Death(DOD) : 
                            Currently Alive 
                            <asp:Button ID="btn_Edit" OnClick="btn_Edit_Click" class="btn btn-primary" runat="server" Text="Edit" />
