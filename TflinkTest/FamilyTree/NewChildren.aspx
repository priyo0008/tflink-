<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewChildren.aspx.cs" Inherits="TflinkTest.FamilyTree.NewChildren" %>
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                Spouse Id : 
                           <asp:DropDownList ID="ddl_Mothername" OnTextChanged="ddl_Mothername_TextChanged" AutoPostBack="true" CssClass="form-control" runat="server">
                           </asp:DropDownList>
                            </div>
                            <div class="col-md-3">
                                Spouse  : 
                                 <asp:TextBox ID="txt_Mothername" ReadOnly="true" CssClass="form-control" runat="server"></asp:TextBox>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                    ...
                    <div class="modal-footer">
                        ...
                        <asp:Button ID="btn_save" class="btn btn-primary"  OnClick="btn_save_Click" runat="server" Text="Save" />
                    </div>
                    <div>
                    </div>
                </div>
