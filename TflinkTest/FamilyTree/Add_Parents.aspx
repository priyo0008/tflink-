<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Add_Parents.aspx.cs" Inherits="TflinkTest.FamilyTree.Add_Parents" %>
    ...
    <form id="form1" runat="server">
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title">Add Parent/Guardian for Profile </h4>
        ...
        <div>
            ...
            <div class="container">
                ...
                <asp:Button ID="btnClose" CssClass="settings" runat="server" Text="Close" OnClick="btnClose_Click" Visible="false" CausesValidation="false" />
            </div>
            <div id="exTab1" class="container">
                <ul class="nav nav-tabs">
                    <li class="active">
                        <a href="#1a" data-toggle="tab">Select Your Parents</a>
                ...
                <div class="tab-content clearfix">
                    ...
                    <div class="tab-pane active" id="1a">
                        <div class="container">
                                    ...
                                    <div class="modal-body">
                                        <div class="row">
                                            <div class="col-md-12" runat="server" id="Bindnotice">
                                                Add Parent/Guardian for Profile
                            ...
                            <asp:DropDownList ID="ddl_paenttypech" CssClass="form-control" runat="server">
                            ...
                            <asp:TextBox ID="txt_Email" onkeyup="ValidateEmail()" onblur="validateEmail(this);" CssClass="form-control" runat="server"></asp:TextBox>
                                ...
                                <cc1:ModalPopupExtender ID="ModalPopupExtender2" BehaviorID="mpeParents" runat="server" PopupControlID="pnlPopUpparents"
                                    ...
                                    <cc1:ModalPopupExtender ID="ModalPopupExtender1" BehaviorID="mpeParents" runat="server" PopupControlID="pnlPopUpparents"
                                        ...
                                        <div class="col-md-row">
                                            <div class="col-md-12" style="overflow: scroll; height: 200px;">
                                                <asp:GridView ID="grd_bindmembers" OnRowDataBound="grd_bindmembers_RowDataBound" Width="100%" CssClass="table-responsive table table-bordered" runat="server" CellPadding="4" AutoGenerateColumns="false" ForeColor="#333333" GridLines="None">
                                                    <Columns>
                                                        <asp:TemplateField>
                                                            <ItemTemplate>
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <asp:Button ID="btn_Savee" runat="server" class="btn btn-info btn-lg" OnClick="btn_Save_Click2" Text="Save" />
                           ...
                           <p id="curalive" runat="server"> Currently Alive </p>
                            ...
                            <asp:TextBox ID="txt_notes" TextMode="MultiLine" Rows="3" CssClass="form-control" runat="server"></asp:TextBox>
                                    ...
                                    <div class="modal-footer">
                                        <%--<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>--%>
                                        <%--<button type="button" class="btn btn-primary">Save</button>--%>
                                        <asp:Button ID="Button1" class="btn btn-primary" OnClick="btn_save_Click" OnClientClick="return Validate();" runat="server" Text="Save" />
                                    </div>
                                    <div>
                                    </div>
                                </div>
